...
#this takes awhile, update to include vectorization with pandas series
# for team in df['team']:
# 	team_frame = df.ix[df['team'] == team, :]
# 	
# 	for year in team_frame['season']:
# 		year_frame = team_frame.ix[team_frame['season'] == year, :]
# 		conf = year_frame['conf_opp'].value_counts().idxmax()
# 		df.ix[(df['team'] == team) & (df['season'] == year), 'conf'] = conf
